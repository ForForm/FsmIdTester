...
namespace BarkodesDeviceVerison
{
    public class CommunicationCode
    {
        ...
        public byte[] getManufacturerCode(ManufacturerCode code)
        {
    ...
    public class ComMng
    {
        ...
        */
        ...
        public ReturnValues SetDeviceVersionFsm(string IP, int TcpPort, int TargetAddress, byte version, CommunicationCode.ManufacturerCode code, int msTimeOut, Converter cnv)
        {
            try
            {
                TcpClient client = new TcpClient();
                ...
                stream[5] = 0;
                stream[6] = version;
                CommunicationCode cd = new CommunicationCode();
                Array.Copy(cd.getManufacturerCode(code), 0, stream, 7, 8);
